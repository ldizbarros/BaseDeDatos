...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTableUsuarios.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "NOMBRE", "APELLIDOS", "FECHA NACIMIENTO", "TELEFONO"
            }
        ) {
        ...
        jB_Borrar.setText("Borrar Usuario");
    ...
    private void jB_ModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jB_ModificarActionPerformed
        try{
            ...
            jTF_APELLIDOS.setText(us.getApellidos());
            jTF_FECHA.setText(us.getFechaNaciemiento());
            jTF_TELEFONO.setText(String.valueOf(us.getTelefono()));
        }catch(ArrayIndexOutOfBoundsException ex){
            JOptionPane.showMessageDialog(rootPane, "No has selecionado un usuario");
        }   
